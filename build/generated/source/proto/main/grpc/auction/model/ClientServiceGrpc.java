...
public final class ClientServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<auction.model.OfferChangedRequest,
      auction.model.OfferChangedResponse> getOfferChangedMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "OfferChanged",
      requestType = auction.model.OfferChangedRequest.class,
      responseType = auction.model.OfferChangedResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<auction.model.OfferChangedRequest,
      auction.model.OfferChangedResponse> getOfferChangedMethod() {
    io.grpc.MethodDescriptor<auction.model.OfferChangedRequest, auction.model.OfferChangedResponse> getOfferChangedMethod;
      ...
      synchronized (ClientServiceGrpc.class) {
        if ((getOfferChangedMethod = ClientServiceGrpc.getOfferChangedMethod) == null) {
          ClientServiceGrpc.getOfferChangedMethod = getOfferChangedMethod =
              io.grpc.MethodDescriptor.<auction.model.OfferChangedRequest, auction.model.OfferChangedResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "OfferChanged"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  auction.model.OfferChangedRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  auction.model.OfferChangedResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void offerChanged(auction.model.OfferChangedRequest request,
        io.grpc.stub.StreamObserver<auction.model.OfferChangedResponse> responseObserver) {
  ...
  public static final class ClientServiceStub
    ...
    /**
     */
    public void offerChanged(auction.model.OfferChangedRequest request,
        io.grpc.stub.StreamObserver<auction.model.OfferChangedResponse> responseObserver) {
  ...
  public static final class ClientServiceBlockingStub
    ...
    /**
     */
    public auction.model.OfferChangedResponse offerChanged(auction.model.OfferChangedRequest request) {
  ...
  public static final class ClientServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<auction.model.OfferChangedResponse> offerChanged(
        auction.model.OfferChangedRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_OFFER_CHANGED:
          serviceImpl.offerChanged((auction.model.OfferChangedRequest) request,
              (io.grpc.stub.StreamObserver<auction.model.OfferChangedResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              auction.model.OfferChangedRequest,
              auction.model.OfferChangedResponse>(
  ...
  private static abstract class ClientServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return auction.model.ClientServiceOuterClass.getDescriptor();
    }
